...
st.markdown("""
Enter a research idea below and explore how different parts of the research ecosystem might view it.
""")
...
if st.button("Translate"):
    ...
    with col1:
        ...
        st.write(
            f"This project requires consideration of resources, staffing, equipment and "
    ...
    with col2:
        ...
        st.write(
            f"This project may involve intellectual property, collaboration agreements "
            "and data-sharing arrangements."
        )

        st.subheader("⚖️ Ethics")
        st.write(
            f"This project requires consideration of ethical implications, governance "
